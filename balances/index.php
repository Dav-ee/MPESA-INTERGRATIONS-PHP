...
/* access token */
  ...
  $curl_post_data = array(
    ...
    'QueueTimeOutURL'     => 'https://validdomainpath/bal_timeout.php',                      # URL where Timeout Response will be sent to
    'ResultURL'           => 'https://validdomainpath/bal_result.php'                      # URL where Result Response will be sent to
  );
